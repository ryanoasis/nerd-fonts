 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Noto.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Noto.zip)
   * [Noto.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Noto.tar.xz) (smaller)
