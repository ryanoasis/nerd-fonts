 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [ProggyClean.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/ProggyClean.zip)
   * [ProggyClean.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/ProggyClean.tar.xz) (smaller)
