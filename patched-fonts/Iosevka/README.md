 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Iosevka.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Iosevka.zip)
   * [Iosevka.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Iosevka.tar.xz) (smaller)
