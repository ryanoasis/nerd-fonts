 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Monoid.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Monoid.zip)
   * [Monoid.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Monoid.tar.xz) (smaller)
