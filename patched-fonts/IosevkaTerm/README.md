 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [IosevkaTerm.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/IosevkaTerm.zip)
   * [IosevkaTerm.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/IosevkaTerm.tar.xz) (smaller)
