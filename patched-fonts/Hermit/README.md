 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Hermit.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Hermit.zip)
   * [Hermit.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Hermit.tar.xz) (smaller)
