 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Overpass.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Overpass.zip)
   * [Overpass.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Overpass.tar.xz) (smaller)
