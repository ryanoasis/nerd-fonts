 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [AnonymousPro.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AnonymousPro.zip)
   * [AnonymousPro.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AnonymousPro.tar.xz) (smaller)
