 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [IntelOneMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/IntelOneMono.zip)
   * [IntelOneMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/IntelOneMono.tar.xz) (smaller)
