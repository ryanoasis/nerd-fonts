 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [UbuntuSans.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/UbuntuSans.zip)
   * [UbuntuSans.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/UbuntuSans.tar.xz) (smaller)
