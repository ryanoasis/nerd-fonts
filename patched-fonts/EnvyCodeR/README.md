 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [EnvyCodeR.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/EnvyCodeR.zip)
   * [EnvyCodeR.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/EnvyCodeR.tar.xz) (smaller)
