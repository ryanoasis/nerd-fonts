 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [RobotoMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/RobotoMono.zip)
   * [RobotoMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/RobotoMono.tar.xz) (smaller)
