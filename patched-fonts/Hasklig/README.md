 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Hasklig.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Hasklig.zip)
   * [Hasklig.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Hasklig.tar.xz) (smaller)
