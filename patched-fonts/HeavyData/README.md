 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [HeavyData.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/HeavyData.zip)
   * [HeavyData.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/HeavyData.tar.xz) (smaller)
