 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [LiberationMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/LiberationMono.zip)
   * [LiberationMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/LiberationMono.tar.xz) (smaller)
