 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Tinos.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Tinos.zip)
   * [Tinos.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Tinos.tar.xz) (smaller)
