 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [ProFont.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/ProFont.zip)
   * [ProFont.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/ProFont.tar.xz) (smaller)
