 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [UbuntuMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/UbuntuMono.zip)
   * [UbuntuMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/UbuntuMono.tar.xz) (smaller)
