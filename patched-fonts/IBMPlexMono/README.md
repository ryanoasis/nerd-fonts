 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [IBMPlexMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/IBMPlexMono.zip)
   * [IBMPlexMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/IBMPlexMono.tar.xz) (smaller)
