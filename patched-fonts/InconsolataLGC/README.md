 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [InconsolataLGC.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/InconsolataLGC.zip)
   * [InconsolataLGC.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/InconsolataLGC.tar.xz) (smaller)
