 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [GeistMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/GeistMono.zip)
   * [GeistMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/GeistMono.tar.xz) (smaller)
