 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [ShareTechMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/ShareTechMono.zip)
   * [ShareTechMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/ShareTechMono.tar.xz) (smaller)
