 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [SpaceMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/SpaceMono.zip)
   * [SpaceMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/SpaceMono.tar.xz) (smaller)
