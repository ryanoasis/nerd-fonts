 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [BigBlueTerminal.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/BigBlueTerminal.zip)
   * [BigBlueTerminal.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/BigBlueTerminal.tar.xz) (smaller)
