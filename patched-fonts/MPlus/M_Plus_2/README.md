 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [MPlus.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/MPlus.zip)
   * [MPlus.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/MPlus.tar.xz) (smaller)
