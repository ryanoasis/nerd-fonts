 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [BitstreamVeraSansMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/BitstreamVeraSansMono.zip)
   * [BitstreamVeraSansMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/BitstreamVeraSansMono.tar.xz) (smaller)
