...
## Why `D2KodingLigature` and not `D2Coding`?
 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [D2Coding.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/D2Coding.zip)
   * [D2Coding.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/D2Coding.tar.xz) (smaller)
