 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Agave.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Agave.zip)
   * [Agave.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Agave.tar.xz) (smaller)
