 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [InconsolataGo.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/InconsolataGo.zip)
   * [InconsolataGo.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/InconsolataGo.tar.xz) (smaller)
