 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Lilex.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Lilex.zip)
   * [Lilex.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Lilex.tar.xz) (smaller)
