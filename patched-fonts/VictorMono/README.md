 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [VictorMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/VictorMono.zip)
   * [VictorMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/VictorMono.tar.xz) (smaller)
