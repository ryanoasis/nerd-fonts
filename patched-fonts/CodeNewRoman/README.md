 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [CodeNewRoman.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/CodeNewRoman.zip)
   * [CodeNewRoman.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/CodeNewRoman.tar.xz) (smaller)
