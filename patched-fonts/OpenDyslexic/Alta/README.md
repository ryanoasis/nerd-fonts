...
'Alta' has a closed small letter a, while 'Regular' has the open form.
 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [OpenDyslexic.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/OpenDyslexic.zip)
   * [OpenDyslexic.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/OpenDyslexic.tar.xz) (smaller)
