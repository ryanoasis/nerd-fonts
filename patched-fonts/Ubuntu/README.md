 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Ubuntu.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Ubuntu.zip)
   * [Ubuntu.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Ubuntu.tar.xz) (smaller)
