 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [AurulentSansMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AurulentSansMono.zip)
   * [AurulentSansMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AurulentSansMono.tar.xz) (smaller)
