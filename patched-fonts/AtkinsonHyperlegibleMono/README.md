 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [AtkinsonHyperlegibleMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AtkinsonHyperlegibleMono.zip)
   * [AtkinsonHyperlegibleMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AtkinsonHyperlegibleMono.tar.xz) (smaller)
