...
**Annotation Mono** is an idealized handwriting; legibility is maximized while retaining a hand-written character.

For more information have a look at the upstream website: https://github.com/qwerasd205/AnnotationMono
 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [AnnotationMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AnnotationMono.zip)
   * [AnnotationMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/AnnotationMono.tar.xz) (smaller)
