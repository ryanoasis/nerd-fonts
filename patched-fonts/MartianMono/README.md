 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [MartianMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/MartianMono.zip)
   * [MartianMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/MartianMono.tar.xz) (smaller)
