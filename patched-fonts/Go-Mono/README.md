 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [Go-Mono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Go-Mono.zip)
   * [Go-Mono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Go-Mono.tar.xz) (smaller)
