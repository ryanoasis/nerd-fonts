 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [ZedMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/ZedMono.zip)
   * [ZedMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/ZedMono.tar.xz) (smaller)
