#!/usr/bin/env bash
# Codicons (version 0.0.45, 540 icons)
# Codepoints: EA60-EC84 with gaps
...
i='' i_cod_git_fetch=$i
i='' i_cod_copilot=$i
i='' i_cod_lightbulb_sparkle=$i
i='' i_cod_robot=$i
i='' i_cod_sparkle_filled=$i
i='' i_cod_diff_single=$i
i='' i_cod_diff_multiple=$i
i='' i_cod_surround_with=$i
i='' i_cod_share=$i
i='' i_cod_git_stash=$i
i='' i_cod_git_stash_apply=$i
i='' i_cod_git_stash_pop=$i
i='' i_cod_vscode=$i
i='' i_cod_vscode_insiders=$i
i='' i_cod_code_oss=$i
i='' i_cod_run_coverage=$i
i='' i_cod_run_all_coverage=$i
i='' i_cod_coverage=$i
i='' i_cod_github_project=$i
i='' i_cod_map_vertical=$i
i='' i_cod_map_vertical_filled=$i
i='' i_cod_go_to_search=$i
i='' i_cod_percentage=$i
i='' i_cod_attach=$i
i='' i_cod_go_to_editing_session=$i
i='' i_cod_edit_session=$i
i='' i_cod_code_review=$i
i='' i_cod_copilot_warning=$i
i='' i_cod_python=$i
i='' i_cod_copilot_large=$i
i='' i_cod_copilot_warning_large=$i
i='' i_cod_keyboard_tab=$i
i='' i_cod_copilot_blocked=$i
i='' i_cod_copilot_not_connected=$i
i='' i_cod_flag=$i
i='' i_cod_lightbulb_empty=$i
i='' i_cod_symbol_method_arrow=$i
i='' i_cod_copilot_unavailable=$i
i='' i_cod_repo_pinned=$i
i='' i_cod_keyboard_tab_above=$i
i='' i_cod_keyboard_tab_below=$i
i='' i_cod_git_pull_request_done=$i
i='' i_cod_mcp=$i
i='' i_cod_extensions_large=$i
i='' i_cod_layout_panel_dock=$i
i='' i_cod_layout_sidebar_left_dock=$i
i='' i_cod_layout_sidebar_right_dock=$i
i='' i_cod_copilot_in_progress=$i
i='' i_cod_copilot_error=$i
i='' i_cod_copilot_success=$i
i='' i_cod_chat_sparkle=$i
i='' i_cod_search_sparkle=$i
i='' i_cod_edit_sparkle=$i
i='' i_cod_copilot_snooze=$i
i='' i_cod_send_to_remote_agent=$i
i='' i_cod_comment_discussion_sparkle=$i
i='' i_cod_chat_sparkle_warning=$i
i='' i_cod_chat_sparkle_error=$i
i='' i_cod_collection=$i
i='' i_cod_new_collection=$i
i='' i_cod_thinking=$i
i='' i_cod_build=$i
i='' i_cod_comment_discussion_quote=$i
i='' i_cod_cursor=$i
i='' i_cod_eraser=$i
i='' i_cod_file_text=$i
i='' i_cod_quotes=$i
i='' i_cod_rename=$i
i='' i_cod_run_with_deps=$i
i='' i_cod_debug_connected=$i
i='' i_cod_strikethrough=$i
i='' i_cod_open_in_product=$i
i='' i_cod_index_zero=$i
i='' i_cod_agent=$i
i='' i_cod_edit_code=$i
i='' i_cod_repo_selected=$i
i='' i_cod_skip=$i
i='' i_cod_merge_into=$i
i='' i_cod_git_branch_changes=$i
i='' i_cod_git_branch_staged_changes=$i
i='' i_cod_git_branch_conflicts=$i
i='' i_cod_git_branch=$i
i='' i_cod_search_large=$i
i='' i_cod_terminal_git_bash=$i
i='' i_cod_window_active=$i
i='' i_cod_forward=$i
i='' i_cod_download=$i
i='' i_cod_clockface=$i
i='' i_cod_unarchive=$i
i='' i_cod_session_in_progress=$i
i='' i_cod_collection_small=$i
i='' i_cod_vm_small=$i
i='' i_cod_cloud_small=$i
i='' i_cod_add_small=$i
i='' i_cod_remove_small=$i
i='' i_cod_worktree_small=$i
i='' i_cod_worktree=$i
i='' i_cod_screen_cut=$i
i='' i_cod_ask=$i
i='' i_cod_openai=$i
i='' i_cod_claude=$i
i='' i_cod_open_in_window=$i
i='' i_cod_new_session=$i
unset i
