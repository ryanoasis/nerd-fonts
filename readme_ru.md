...
* **`34`** [улучшенных семейства шрифтов](#patched-fonts)
* Более **`77,000`** уникальных комбинаций/вариантов улучшенненных шрифтов [(больше информации)](#combinations)
...
- Более **`77,000`** уникальных вариантов/комбинаций (Power Set) улучшенных шрифтов:
  - **`34`** улучшенных набора шрифтов
  - **`149`** улучшенных семейств шрифтов
  - **`596`** 'выполненных' вариантов/комбинаций
  - **`76,502`** _возможных_ варианта/комбинации
  - **`77,098`** всего вычислено комбинаций (596 + 76,502)
